    ...
    <>
      ...
      <div className="board">
            ...
            <div key={article.id} className="card">
              ...
              {isExpanded && (
                <div className="details">
                  ...
                  <div className="ad-container ad-container__inline">
                    <ins
                      className="adsbygoogle"
                      style={{ display: 'block' }}
                      data-ad-client="ca-pub-8612922709654862"
                      data-ad-slot="7817950307"
                      data-ad-format="auto"
        ...
        <style jsx>{`
          ...
          :global(.ad-container .adsbygoogle),
